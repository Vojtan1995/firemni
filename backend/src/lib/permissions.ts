...
const PERMISSION_MATRIX: Record<Permission, UserRole[]> = {
  ...
  'seal.status': [UserRole.vedeni, UserRole.admin],
  ...
  'reports.view': [UserRole.worker, UserRole.vedeni, UserRole.admin],
  'reports.export': [UserRole.worker, UserRole.vedeni, UserRole.admin],
  'priceList.view': [UserRole.worker, UserRole.vedeni, UserRole.admin],
